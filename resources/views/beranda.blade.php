  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
            <a class="nav-link" href="/beranda/admin">Encyclopedia</a>
          </li>
        {{-- <li class="nav-item">
        ...
        {{-- <li class="nav-item">
          <a class="nav-link" href="/shop/admin">Object</a>
        </li> --}}
        <li class="nav-item">
        ...
        <li>
          <a href="/dshbrd" class="btn btn-outline-dark">Buat Artikel</a>
...
<body>
    <div class="container">
        <h1 class="text-center mt-4 mb-4" style="margin-right: 110vh;">Articles</h1>
        <div class="row">
