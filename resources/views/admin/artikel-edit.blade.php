    ...
    <div class="login-container">
        ...
        <form action="/artikel/edit/{{$artikel->id}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="name" class="form-control" id="name" placeholder="Enter judul" name="judul" value="{{$artikel->judul}}">
            </div>
            <div class="form-group">
                <label for="category">Kategori</label>
                <select class="form-control" id="category" value="{{$artikel->kategori}}" name="kategori">
            ...
            <div class="form-group" style="margin-top: 5px">
                ...
                <input type="file" class="form-control-file" id="image" value="{{$artikel->foto}}" name="foto">
            </div>
            <div class="form-group">
                <label for="deskripsi">Deskripsi Singkat</label>
                <input type="text" name="deskripsi" id="" placeholder="Enter deskripsi" class="form-control" value="{{$artikel->deskripsi}}">
            </div>
